...
\node[gatebox, minimum width=13.5cm]
    (footer) at (6.45,-8.2) {tree remains \textbf{READY} on success; \texttt{freeze} builds on add/commit/push/tag and emits a \texttt{.gts}};
