...
% Annotations
\node[label, right=0.3cm of root] {initialise(.cgs) seeds the root GitTree entry};
...
\node[label, below=0.15cm of root] {cross-references are canonicalized to keep a DAG at runtime};
