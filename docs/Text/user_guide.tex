...
the selected remote branch with \texttt{git fetch}, \texttt{git reset --hard},
and \texttt{git clean -fd}; child submodules are then force-updated
parent-first.  This command can discard local uncommitted changes and
untracked files.
