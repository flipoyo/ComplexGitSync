...
discover nested configs, check out the current branch across the tree, and end
in \texttt{READY}.  \texttt{.gts} sources restore the saved state, cloning
missing repositories and checking out recorded refs as needed.
