...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync remember <spec.cgs> [--output-path DIR] [--service HOST] [--remote-name NAME]
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync memorize <memory-state-dir> [--branch BRANCH]
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync retrieve <name> [--output-path DIR] [--branch BRANCH] [--service HOST] [--remote-name NAME]
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ pixi run cgitsync reload <name> [--output-path DIR] [--branch BRANCH] [--service HOST] [--remote-name NAME]
\end{lstlisting}
...
against the live repositories) as \texttt{AgentSpecs/Onboarding\_DevPlanTicket.md}
