...
(Kahn's BFS algorithm) for safe sequential clone/pull operations.
...
Current implementation names such as \texttt{clone}, \texttt{restart},
\texttt{freeze-release}, \texttt{freeze-state}, \texttt{launch-release}, and
\texttt{launch-state} remain compatibility surfaces around this lifecycle.
...
src/ComplexGitSync/
  ...
  orchestre.py                 ConfigDocument, CgsDocument,
                               GtsDocument, GocDocument
