...
\hline
\texttt{read(.cgs)}              & none        & \texttt{.gts LOADED} \\
\texttt{expand(.gts)}            & LOADED      & \texttt{.gts PENDING} \\
\texttt{verify(.gts)}            & PENDING     & \texttt{.gts READY} \\
\texttt{clone(.gts)}             & READY       & \textbf{READY} \\
...
\texttt{tag}                     & \textbf{READY only} & READY + updated tag \\
