...
\begin{lstlisting}[language=bash]
$ cgitsync checkout <branch> --gts <source.gts|source.cgs> [--ref-kind branch|tag]
\end{lstlisting}

Checks out a branch or tag across the whole tree, parent-first.
Loads the READY registry from \texttt{--gts} (directly from \texttt{.gts} or by
resolving the latest runtime snapshot for \texttt{.cgs}), then propagates the ref,
...
\begin{lstlisting}[language=bash]
$ cgitsync commit <message> --gts <source.gts|source.cgs> [--no-stage]
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ cgitsync push --gts <source.gts|source.cgs>
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ cgitsync tag <name> --gts <source.gts|source.cgs>
\end{lstlisting}
...
\begin{lstlisting}[language=bash]
$ cgitsync freeze-release <name> --gts <source.gts|source.cgs>
\end{lstlisting}
...
client.load_source("project.cgs")          # or
client.load_source(".cgitsync/state/project.gts")
